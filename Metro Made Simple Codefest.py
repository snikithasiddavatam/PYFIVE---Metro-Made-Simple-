...
if username=='123' and password=='1234':
    ...
    while(True):
        ...
        if menu=='1':
            ...
            for i in range(0,len(transactionDetails)):
                if(transactionDetails[i]<0):
                    print("Purchase : ",str(-1*transactionDetails[i]))
                else:
                    print("Recharge : ",str(transactionDetails[i]))
        elif menu=='10':
            break;
else:
    print("Incorrect!")
